...
export default function Skeleton(props: IProps) {
    return (
        <div role="status" className={`w-[${599 * props.scale}px] rounded shadow animate-pulse`}>
            {props.withImage && <div className="flex items-center justify-center h-48 mb-4 bg-gray-300 rounded">
